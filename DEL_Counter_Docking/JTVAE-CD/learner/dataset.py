...
class MolTreeFolder(object):
    ...
    def __iter__(self):
        for fn in self.data_files:
            ...
            dataset = MolTreeDataset(self.config, batches, self.vocab, self.assm, 'given')
...
class MolTreeDataset(Dataset):
    ...
    def __init__(self, config, data = None, vocab = None, assm=True, kind = 'train'):
        self.config = config
        self.data = data
