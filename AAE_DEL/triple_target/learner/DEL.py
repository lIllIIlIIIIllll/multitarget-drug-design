...
class DEL():
    ...
    def train(self):
        ...
        for g in range(self.config.get('num_generations')):
            ...
            properties = samples.loc[:, ['SAS', 'logP', 'CA9', 'GPX4', 'LPA1']]  # qed: the larger the better, SAS: the smaller the better, logP: the smaller the better
    ...
    def get_properties(self, samples, n_jobs=60):
