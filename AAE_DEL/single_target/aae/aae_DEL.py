...
class AAE_DEL:
    ...
    def train(self):
        ...
        for g in range(generations):
            ...
            if self.config.get('ranking') == 'sopr':
                ...
                _, dists_vec = self.crowding_distance_all_fronts(properties, Fs, p_min, p_max, n_jobs=36)
            ...
            if self.config.get('ranking') == 'sopr':
                ...
                dists_all, dists_vec = self.crowding_distance_all_fronts(combined_properties, Fs, p_min, p_max, n_jobs=36)
    ...
    def get_properties(self, samples, n_jobs=36):
    ...
    def crowding_distance_all_fronts(self, P, Fs, f_min, f_max, n_jobs=36):
        '''
        P: Properties
        Fs: fronts
    ...
    def tournament_selection_N(self, num, rank, dists_vec, prob_ts, k=2, n_jobs=36):
        '''
        Select num points
        k: scalar, number of points to be randomly selected from the population
        '''
