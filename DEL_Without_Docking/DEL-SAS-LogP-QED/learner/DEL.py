...
class DEL():
    ...
    def train(self):
        ...
        for g in range(self.config.get('num_generations')):
            ...
            properties = samples.loc[:,['SAS', 'logP', 'qed']] # SAS: the smaller the better, logP: the smaller the better, CA9: the smaller the better, GPX4: the smaller the better
            ...
            combined_properties = combined_samples.loc[:,['SAS', 'logP', 'qed']]
