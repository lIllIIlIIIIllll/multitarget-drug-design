...
class DEL():
    ...
    def train(self):
        ...
        for g in range(self.config.get('num_generations')):
            ...
            properties = samples.loc[:,['SAS', 'logP', 'LPA1']] # SAS: the smaller the better, logP: the smaller the better, score: the smaller the better
            ...
            _,dists_vec=self.crowding_distance_all_fronts(properties, Fs, p_min, p_max, n_jobs=32)
            ...
            combined_properties = combined_samples.loc[:,['SAS', 'logP', 'LPA1']]
            ...
            dists_all,dists_vec=self.crowding_distance_all_fronts(combined_properties, Fs, p_min, p_max, n_jobs=32)
...
#        return selected_inds
    ...
    def get_properties(self, samples, n_jobs=32):
...
#        return dists_all, dists_vec
    ...
    def crowding_distance_all_fronts( self, P, Fs, f_min, f_max, n_jobs=32):
        """
        P: properties.
        Fs: fronts.
        f_min: min values of propreties
